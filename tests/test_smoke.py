        ...
        lambda request: SearchResponse(
            ...
            results=[
                SearchResult(
                    ...
                    title="Weak Signals",
                    bundle_id="bundle-1",
                    source_id="weak-signals",
                    origin_url="https://example.com/weak-signals",
                    direct_paper_url=None,
                    matched_content_role="summary",
                    matched_segment_text="snippet",
                    combined_score=0.73,
                    rank_reason="lexical rank 1",
                ),
                SearchResult(
                    result_kind="source",
                    title="Agency Memory",
                    bundle_id="bundle-1",
                    source_id="agency-memory",
                    origin_url="https://example.com/agency-memory",
                    direct_paper_url=None,
                    matched_content_role="abstract",
                    matched_segment_text="snippet",
                    combined_score=0.70,
                    rank_reason="vector rank 1",
                ),
            ],
        ),
    )
